...
import {MyCustomValidator, UniqueIdValidator, FirstCharacterUpperCaseFieldValidator} from './app.custom.validator';
@Component({
...
export class ProductReactiveFormComponent implements OnInit {
     ...
     this.frmPrd = new FormGroup({
        ProductId: new FormControl(this.product.ProductId,
           Validators.compose([
              ...
              UniqueIdValidator.hasUnique(this.products.map(p => p.ProductId))
           ])),
  ...
  getSelectedCategory(evt): void {
    ...
    this.frmPrd.setControl("Category", new FormControl(this.product.Category))
    }
}